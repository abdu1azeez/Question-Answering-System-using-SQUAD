...
from util import load_preprocess_data, load_embeddings
...
tf.app.flags.DEFINE_string("train_dir", "train" + model_name, "Training directory to save the model parameters (default: ./train).")
...
def main(_):
    ...
    train_data, val_data = load_preprocess_data(FLAGS.data_dir, FLAGS.max_context_len, FLAGS.max_question_len)
